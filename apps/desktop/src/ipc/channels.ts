...
export const ENSURE_P2P_ENVIRONMENT_CHANNEL = "desktop:ensure-p2p-environment";
export const DISCONNECT_P2P_ENVIRONMENT_CHANNEL = "desktop:disconnect-p2p-environment";
